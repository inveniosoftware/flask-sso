...
htmlhelp_basename = 'Flask-SSOdoc'
...
latex_documents = [
  ('index', 'Flask-SSO.tex', u'Flask-SSO Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    ('index', 'flask-sso', u'Flask-SSO Documentation',
     [u'CERN'], 1)
]
...
texinfo_documents = [
  ('index', 'Flask-SSO', u'Flask-SSO Documentation',
   u'CERN', 'Flask-SSO', 'One line description of project.',
   'Miscellaneous'),
]
